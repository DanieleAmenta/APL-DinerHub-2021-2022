...
public:
    ...
    void setupUi(QDialog *AdminGUI)
    {
        ...
        userList->setObjectName(QString::fromUtf8("userList"));
        userList->setGeometry(QRect(0, 50, 781, 371));
        ...
        aaa = new QTextEdit(UserList);
        aaa->setObjectName(QString::fromUtf8("aaa"));
        aaa->setGeometry(QRect(240, 480, 104, 87));
        ...
        tableWidget = new QTableWidget(RestaurantList);
        ...
        AdminInterface->setCurrentIndex(2);
    ...
    void retranslateUi(QDialog *AdminGUI)
    {
        ...
        ___qtablewidgetitem7->setText(QCoreApplication::translate("AdminGUI", "Address", nullptr));
        QTableWidgetItem *___qtablewidgetitem8 = tableWidget->horizontalHeaderItem(2);
        ___qtablewidgetitem8->setText(QCoreApplication::translate("AdminGUI", "Name", nullptr));
