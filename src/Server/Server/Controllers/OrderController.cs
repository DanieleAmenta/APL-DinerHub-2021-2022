    ...
    public class OrderController : ControllerBase
    {
        ...
        public IActionResult Post(Order order)
        {
            try
            {
                ...
                int LastOrderId = dbClient.GetDatabase("dinerhub").GetCollection<Order>("Order").AsQueryable().Count();
        ...
        public IActionResult GetStatus(int orderId)
        {
            try
            {
                // TODO: check if parameter is double
                MongoClient dbClient = new MongoClient(_configuration.GetConnectionString("DinerHubConn"));
